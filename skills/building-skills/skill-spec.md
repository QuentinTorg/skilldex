# Skill Specification: skill-builder
...
- **Workflow Flexibility:** While the skill defines a total 4-phase creation workflow, the agent must understand that it can and should skip phases depending on the user's specific request. If the user only wants a review of an existing `SKILL.md`, the agent can skip directly to Phase 4 (Audit and Refinement).
...
*The following reference documents have been successfully migrated and are available in `skills/skill-builder/references/`:*
