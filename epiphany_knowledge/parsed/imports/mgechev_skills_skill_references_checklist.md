# mgechev_skills_skill_references_checklist.md [DISTILLED]

**Summary:** A QA checklist for skills. Confirms standard agentskills specs and enforces "no human docs" rule and flat hierarchy. Extracted relevant strict rules to skill-specification topic.

**Source:** https://github.com/mgechev/skills-best-practices/blob/skill/references/checklist.md
