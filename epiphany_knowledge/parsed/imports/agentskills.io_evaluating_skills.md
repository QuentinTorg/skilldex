# agentskills.io_evaluating_skills.md [DISTILLED]

**Summary:** This document outlines how to evaluate the quality of agent skills using an iterative loop. It details the creation of test cases, running evaluations, adding and grading verifiable assertions, and iterating on the skill based on a mix of metrics and human feedback. Extracted to [Skill Evaluation](../../topics/skill-evaluation.md).

**Source:** /home/qt/dev/epiphany/docs/skill_references/agentskills.io_evaluating_skills.md
