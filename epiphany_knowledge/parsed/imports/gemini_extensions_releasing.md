# gemini_extensions_releasing.md [DISTILLED]

**Source:** https://geminicli.com/docs/extensions/releasing/

**Summary:** Instructions on releasing Gemini CLI extensions via Git or GitHub Releases, including gallery listing and repository migration. Included in [Skill Packaging and Distribution](../topics/skill-packaging-and-distribution.md) and [Extension Architectures](../topics/extension-architectures.md).
...
.astro-3ef6ksr2}](https://github.com/google-gemini/gemini-cli/issues/new?template=website_issue.yml&url=https%3A%2F%2Fgeminicli.com%2Fdocs%2Fextensions%2Freleasing%2F){.feedback-link
...
-   [[List your extension in the gallery]{.astro-g2bywc46
    style="--depth: 0;"}](#list-your-extension-in-the-gallery){.astro-g2bywc46
    style="--depth: 0;"}
-   [[Release through a Git repository]{.astro-g2bywc46
    style="--depth: 0;"}](#release-through-a-git-repository){.astro-g2bywc46
    style="--depth: 0;"}
    -   [[Manage release channels]{.astro-g2bywc46
        style="--depth: 1;"}](#manage-release-channels){.astro-g2bywc46
        style="--depth: 1;"}
-   [[Release through GitHub Releases]{.astro-g2bywc46
    style="--depth: 0;"}](#release-through-github-releases){.astro-g2bywc46
    style="--depth: 0;"}
    -   [[Custom pre-built archives]{.astro-g2bywc46
        style="--depth: 1;"}](#custom-pre-built-archives){.astro-g2bywc46
        style="--depth: 1;"}
-   [[Migrating an Extension Repository]{.astro-g2bywc46
    style="--depth: 0;"}](#migrating-an-extension-repository){.astro-g2bywc46
    style="--depth: 0;"}
:::
:::
...
# Release extensions {#_top .flex-1 .astro-guvttfii}
...
::: {.sl-container .astro-7nkwcw3z}
::: sl-markdown-content
Release Gemini CLI extensions to your users through a Git repository or
GitHub Releases.

Git repository releases are the simplest approach and offer the most
flexibility for managing development branches. GitHub Releases are more
efficient for initial installations because they ship as single archives
rather than requiring a full `git clone`{dir="auto"}. Use GitHub
Releases if you need to include platform-specific binary files.
...
aria-hidden="true"}[Section titled "List your extension in the
gallery"]{.sr-only}](#list-your-extension-in-the-gallery){.sl-anchor-link}
:::

The [Gemini CLI extension
gallery](https://geminicli.com/extensions/browse/) automatically indexes
public extensions to help users discover your work. You don't need to
submit an issue or email us to list your extension.

To have your extension automatically discovered and listed:

1.  **Use a public repository:** Ensure your extension is hosted in a
    public GitHub repository.
2.  **Add the GitHub topic:** Add the `gemini-cli-extension`{dir="auto"}
    topic to your repository's **About** section. Our crawler uses this
    topic to find new extensions.
3.  **Place the manifest at the root:** Ensure your
    `gemini-extension.json`{dir="auto"} file is in the absolute root of
    the repository or the release archive.

Our system crawls tagged repositories daily. Once you tag your
repository, your extension will appear in the gallery if it passes
validation.
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Release through a Git
repository"]{.sr-only}](#release-through-a-git-repository){.sl-anchor-link}
:::
...
extension using `gemini extensions install <your-repo-uri>`{dir="auto"}.

Users can optionally depend on a specific branch, tag, or commit using
the `--ref`{dir="auto"} argument. For example:

::: expressive-code
<figure class="frame is-terminal not-content">
<pre data-language="bash"><code>gemini extensions install &lt;your-repo-uri&gt; --ref=stable</code></pre>
<div class="copy">
<div>
...
Whenever you push commits to the referenced branch, the CLI prompts
users to update their installation. The `HEAD`{dir="auto"} commit is
always treated as the latest version.

::: {.sl-heading-wrapper .level-h3}
### Manage release channels

[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Manage release
channels"]{.sr-only}](#manage-release-channels){.sl-anchor-link}
:::

You can use branches or tags to manage different release channels, such
as `stable`{dir="auto"}, `preview`{dir="auto"}, or `dev`{dir="auto"}.

We recommend using your default branch as the stable release channel.
This ensures that the default installation command always provides the
most reliable version of your extension. You can then use a
`dev`{dir="auto"} branch for active development and merge it into the
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Release through GitHub
Releases"]{.sr-only}](#release-through-github-releases){.sl-anchor-link}
:::

Distributing extensions through [GitHub
Releases](https://docs.github.com/en/repositories/releasing-projects-on-github/about-releases)
provides a faster installation experience by avoiding a repository
clone.

Gemini CLI checks for updates by looking for the **Latest** release on
GitHub. Users can also install specific versions using the
`--ref`{dir="auto"} argument with a release tag. Use the
`--pre-release`{dir="auto"} flag to install the latest version even if
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Custom pre-built
archives"]{.sr-only}](#custom-pre-built-archives){.sl-anchor-link}
:::

You can attach custom archives directly to your GitHub Release as
assets. This is useful if your extension requires a build step or
includes platform-specific binaries.
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Platform-specific
archives"]{.sr-only}](#platform-specific-archives){.sl-anchor-link}
:::
...
1.  **Platform and architecture-specific:**
    `{platform}.{arch}.{name}.{extension}`{dir="auto"}
2.  **Platform-specific:** `{platform}.{name}.{extension}`{dir="auto"}
3.  **Generic:** A single asset will be used as a fallback if no
    specific match is found.

Use these values for the placeholders:

-   `{name}`{dir="auto"}: Your extension name.
-   `{platform}`{dir="auto"}: Use `darwin`{dir="auto"} (macOS),
    `linux`{dir="auto"}, or `win32`{dir="auto"} (Windows).
-   `{arch}`{dir="auto"}: Use `x64`{dir="auto"} or `arm64`{dir="auto"}.
-   `{extension}`{dir="auto"}: Use `.tar.gz`{dir="auto"} or
    `.zip`{dir="auto"}.

**Examples:**

-   `darwin.arm64.my-tool.tar.gz`{dir="auto"} (specific to Apple Silicon
    Macs)
-   `darwin.my-tool.tar.gz`{dir="auto"} (fallback for all Macs, for
    example Intel)
-   `linux.x64.my-tool.tar.gz`{dir="auto"}
-   `win32.my-tool.zip`{dir="auto"}

::: {.sl-heading-wrapper .level-h4}
#### Archive structure

[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Archive
structure"]{.sr-only}](#archive-structure){.sl-anchor-link}
:::

Archives must be fully contained extensions. The
`gemini-extension.json`{dir="auto"} file must be at the root of the
archive. The rest of the layout should match a standard extension
structure.
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Example GitHub Actions
workflow"]{.sr-only}](#example-github-actions-workflow){.sl-anchor-link}
:::

Use this example workflow to build and release your extension for
multiple platforms:

::: expressive-code
<figure class="frame not-content">
<pre data-language="yaml"><code>name: Release Extension
on:  push:    tags:      - &#39;v*&#39;
jobs:  release:    runs-on: ubuntu-latest    steps:      - uses: actions/checkout@v3
      ...
      - name: Create GitHub Release        uses: softprops/action-gh-release@v1        with:          files: |            release/darwin.arm64.my-tool.tar.gz            release/linux.arm64.my-tool.tar.gz            release/win32.arm64.my-tool.zip</code></pre>
<div class="copy">
<div>
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Migrating an Extension
Repository"]{.sr-only}](#migrating-an-extension-repository){.sl-anchor-link}
:::

If you need to move your extension to a new repository (for example,
from a personal account to an organization) or rename it, you can use
the `migratedTo`{dir="auto"} property in your
`gemini-extension.json`{dir="auto"} file to seamlessly transition your
users.

1.  **Create the new repository**: Setup your extension in its new
    location.
2.  **Update the old repository**: In your original repository, update
    the `gemini-extension.json`{dir="auto"} file to include the
    `migratedTo`{dir="auto"} property, pointing to the new repository
    URL, and bump the version number. You can optionally change the
    `name`{dir="auto"} of your extension at this time in the new
    repository.

    ::: expressive-code
    <figure class="frame not-content">
    <pre data-language="json"><code>{  &quot;name&quot;: &quot;my-extension&quot;,  &quot;version&quot;: &quot;1.1.0&quot;,  &quot;migratedTo&quot;: &quot;https://github.com/new-owner/new-extension-repo&quot;}</code></pre>
    <div class="copy">
    <div>
    ...
    :::
3.  **Release the update**: Publish this new version in your old
    repository.

When users check for updates, Gemini CLI will detect the
`migratedTo`{dir="auto"} field, verify that the new repository contains
a valid extension update, and automatically update their local
installation to track the new source and name moving forward. All
extension settings will automatically migrate to the new installation.
:::
