# agentskills.io_what_are_skills.md [DISTILLED]

**Summary:** Defines what Agent Skills are (a lightweight, open format for extending capabilities) and explains how they use progressive disclosure (Discovery, Activation, Execution) and the `SKILL.md` file structure. [See: ## How skills work]

**Source:** /home/qt/dev/epiphany/docs/skill_references/agentskills.io_what_are_skills.md
