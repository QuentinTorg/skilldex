# agentskills.io_skill_creator_optimizing_skill_descriptions.md [DISTILLED]

**Summary:** This document provides a workflow and best practices for writing and optimizing skill descriptions to ensure agents trigger them accurately. It covers trigger mechanics, writing effective descriptions, creating evaluation queries (train/validation splits), and an optimization loop. [See: ## Writing effective descriptions], [See: ## The optimization loop].

**Source:** /home/qt/dev/epiphany/docs/skill_references/agentskills.io_skill_creator_optimizing_skill_descriptions.md
