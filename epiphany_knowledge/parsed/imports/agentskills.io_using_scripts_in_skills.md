# agentskills.io_using_scripts_in_skills.md [DISTILLED]

**Summary:** This document provides guidance on using scripts within Agent Skills. It covers execution models like one-off commands (e.g., using `npx`, `uvx`) and bundling self-contained scripts in a `scripts/` directory. It also outlines essential design principles for agent-friendly scripts, such as avoiding interactive prompts, providing structured output, and ensuring clear error messages. [See: ## Execution Models], [See: ## Designing scripts for agentic use]

**Source:** /home/qt/dev/epiphany/docs/skill_references/agentskills.io_using_scripts_in_skills.md
