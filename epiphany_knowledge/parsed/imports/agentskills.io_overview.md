# agentskills.io_overview.md [DISTILLED]

**Summary:** Overview of the Agent Skills format, detailing its purpose (giving agents context and procedural knowledge), capabilities enabled (domain expertise, repeatable workflows), and its origin and broad adoption across tools like Gemini CLI, Codex, Cursor, and Claude Code [See: ## Why Agent Skills?, ## Adoption].

**Source:** /home/qt/dev/epiphany/docs/skill_references/agentskills.io_overview.md
