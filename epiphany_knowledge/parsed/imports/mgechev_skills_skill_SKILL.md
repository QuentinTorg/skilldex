# mgechev_skills_skill_SKILL.md [DISTILLED]

**Summary:** Example SKILL.md template focusing on procedural steps and progressive disclosure. Reviewed but largely redundant with existing agentskills spec. Not extracted to topics to maintain high signal-to-noise ratio.

**Source:** https://github.com/mgechev/skills-best-practices/blob/skill/SKILL.md
