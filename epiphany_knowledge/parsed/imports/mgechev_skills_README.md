# mgechev_skills_README.md [DISTILLED]

**Summary:** Contains best practices for skill architecture and a valuable section on validating skills via LLM collaboration (Discovery, Logic, Edge Cases, Architecture). Extracted to skill-evaluation and skill-specification topics.

**Source:** https://github.com/mgechev/skills-best-practices/blob/README.md
