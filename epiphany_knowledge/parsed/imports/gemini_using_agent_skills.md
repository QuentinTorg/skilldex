# gemini_using_agent_skills.md [DISTILLED]

**Summary:** This document provides a guide on managing Agent Skills within the Gemini CLI environment. It details the skill discovery tiers (built-in, extension, user, workspace), in-session management slash commands (e.g., `/skills list`, `/skills reload`, `/skills disable`), terminal utilities for installation and linking (`gemini skills install`, `gemini skills link`, `gemini skills uninstall`), and the environment's security model requiring user consent for installation and activation. [See: ## Discovery tiers, ## In-session management, ## Terminal utilities, ## Security and consent].
...
.astro-3ef6ksr2}](https://github.com/google-gemini/gemini-cli/issues/new?template=website_issue.yml&url=https%3A%2F%2Fgeminicli.com%2Fdocs%2Fcli%2Fusing-agent-skills%2F){.feedback-link
...
-   [[Discovery tiers]{.astro-g2bywc46
    ...
    style="--depth: 0;"}
-   [[In-session management]{.astro-g2bywc46
    style="--depth: 0;"}](#in-session-management){.astro-g2bywc46
    style="--depth: 0;"}
-   [[Terminal utilities]{.astro-g2bywc46
    style="--depth: 0;"}](#terminal-utilities){.astro-g2bywc46
    style="--depth: 0;"}
    -   [[Install a skill]{.astro-g2bywc46
        style="--depth: 1;"}](#install-a-skill){.astro-g2bywc46
        style="--depth: 1;"}
    -   [[Link for development]{.astro-g2bywc46
        style="--depth: 1;"}](#link-for-development){.astro-g2bywc46
        style="--depth: 1;"}
    -   [[Uninstall a skill]{.astro-g2bywc46
        style="--depth: 1;"}](#uninstall-a-skill){.astro-g2bywc46
        style="--depth: 1;"}
-   [[Security and consent]{.astro-g2bywc46
    style="--depth: 0;"}](#security-and-consent){.astro-g2bywc46
    style="--depth: 0;"}
...
# Managing Agent Skills {#_top .flex-1 .astro-guvttfii}
...
::: {.sl-container .astro-7nkwcw3z}
::: sl-markdown-content
Agent Skills provide Gemini CLI with specialized expertise on demand.
This guide covers advanced management techniques, including using slash
commands, terminal utilities, and understanding discovery tiers.
...
3.  **User Skills**: Located in `~/.gemini/skills/`{dir="auto"} or the
    `~/.agents/skills/`{dir="auto"} alias. These are available across
    all your projects.
4.  **Workspace Skills**: Located in `.gemini/skills/`{dir="auto"} or
    the `.agents/skills/`{dir="auto"} alias within your current
    directory. These are project-specific.
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "In-session
management"]{.sr-only}](#in-session-management){.sl-anchor-link}
:::

Use the `/skills`{dir="auto"} slash command during an interactive
session to manage your available expertise.

-   **List skills**: `/skills list`{dir="auto"} (shows discovered
    skills).
    -   Use `/skills list all`{dir="auto"} to include internal built-in
        skills.
    -   Use `/skills list nodesc`{dir="auto"} to hide descriptions.
-   **Reload skills**: `/skills reload`{dir="auto"} (or
    `/skills refresh`{dir="auto"}) to scan for new or modified skills
    without restarting the CLI.
-   **Toggle status**:
    -   `/skills disable <name>`{dir="auto"}: Prevents a skill from
        being triggered.
    -   `/skills enable <name>`{dir="auto"}: Re-enables a disabled
        skill.
-   **Link local skills**:
    `/skills link <path> [--scope user|workspace]`{dir="auto"} to
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Terminal
utilities"]{.sr-only}](#terminal-utilities){.sl-anchor-link}
:::

The `gemini skills`{dir="auto"} command provides management utilities
directly from your system shell.

::: {.sl-heading-wrapper .level-h3}
### Install a skill

[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Install a
skill"]{.sr-only}](#install-a-skill){.sl-anchor-link}
:::

To install a skill from a remote repository or a local
`.skill`{dir="auto"} package:

::: expressive-code
<figure class="frame is-terminal not-content">
<pre data-language="bash"><code>gemini skills install https://github.com/user/my-awesome-skill</code></pre>
<div class="copy">
<div>
...
By default, this installs to your **user profile**. Use
`--scope workspace`{dir="auto"} to install it only for the current
project.
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Link for
development"]{.sr-only}](#link-for-development){.sl-anchor-link}
:::

If you are developing a skill, use the `link`{dir="auto"} command to
create a reference to your local directory:

::: expressive-code
<figure class="frame is-terminal not-content">
<pre data-language="bash"><code>gemini skills link ./path/to/my-skill</code></pre>
<div class="copy">
<div>
...
[[![](data:image/svg+xml;base64,)]{.sl-anchor-icon
aria-hidden="true"}[Section titled "Uninstall a
skill"]{.sr-only}](#uninstall-a-skill){.sl-anchor-link}
:::
...
::: expressive-code
<figure class="frame is-terminal not-content">
<pre data-language="bash"><code>gemini skills uninstall &lt;name&gt;</code></pre>
<div class="copy">
<div>
...
consent"]{.sr-only}](#security-and-consent){.sl-anchor-link}
:::

Agent Skills can execute scripts and access your files. To protect your
environment:

1.  **Installation consent**: When installing from a remote URL, you
    will be asked to confirm the source.
2.  **Activation consent**: Every time a skill is triggered during a
    session, the agent must ask for permission to activate it and gain
...
-   [Get started with Agent
    Skills](/docs/cli/tutorials/skills-getting-started): A walkthrough
    for creating your first skill.
-   [Creating Agent Skills](/docs/cli/creating-skills): Detailed guide
    on bundling scripts and assets.
-   [Skill best practices](/docs/cli/skills-best-practices): Strategies
    for building reliable expertise.
:::
